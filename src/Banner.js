...
Banner.prototype.createCanvas = function(template) {
    ...
    function darkBg()
    {
        ...
        ctx.closePath();
        ctx.clip()
        ctx.drawImage('https://cdn.discordapp.com/attachments/514172417174798341/516346545335959565/Sans_titre123.png', 0, 0, width, height);
        ctx.restore();
    }
    ...
    function drawLevelName(x, y, levelName)
    {
        ...
        drawText(x + 15 / 2 - levelName.length * 4.5, y + 15 + 7, levelName, 15, expPanel.rightColor);
    }
